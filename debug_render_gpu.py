"""Test: separate GPU for rendering (GPU 7) vs model (GPU 0)."""
...
model.eval()
print("Model loaded on cuda:0", flush=True)
...
# Use GPU 7 for MuJoCo rendering
RENDER_GPU = 7
print(f"Creating env (render on GPU {RENDER_GPU})...", flush=True)
