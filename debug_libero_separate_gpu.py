"""Debug: Use different GPU for MuJoCo EGL rendering vs model inference."""
import os
os.environ["MUJOCO_GL"] = "egl"
os.environ["EGL_DEVICE_ID"] = "7"  # Use GPU 7 for EGL rendering
...
device = "cuda:0"  # Model on GPU 0
print("Loading model (EGL on GPU 7, model on GPU 0)...", flush=True)
